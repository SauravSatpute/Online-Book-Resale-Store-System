...
book_path = os.path.join('dataset/books.csv')

# For Count Vectorizer
cosine_sim_path = os.path.join('model_files/tf-idf/cosine_rating_sim.npz')
book_indices_path = os.path.join('model_files/tf-idf/indices.pkl')

# For Embedding
book_id_map_path = os.path.join('model_files/surprise/book_raw_to_inner_id.pickle')
book_raw_map_path = os.path.join('model_files/surprise/book_inner_id_to_raw.pickle')
book_embed_path = os.path.join('model_files/surprise/book_embedding.npy')
sim_books_path = os.path.join('model_files/surprise/sim_books.pickle')
