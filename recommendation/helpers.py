...
book_path = os.path.join(os.getcwd()+'/recommendation\dataset/books.csv')

# For Count Vectorizer
cosine_sim_path = os.path.join(os.getcwd()+'/recommendation\model_files/tf-idf/cosine_rating_sim.npz')
book_indices_path = os.path.join(os.getcwd()+'/recommendation\model_files/tf-idf/indices.pkl')

# For Embedding
book_id_map_path = os.path.join(os.getcwd()+'/recommendation\model_files/surprise/book_raw_to_inner_id.pickle')
book_raw_map_path = os.path.join(os.getcwd()+'/recommendation\model_files/surprise/book_inner_id_to_raw.pickle')
book_embed_path = os.path.join(os.getcwd()+'/recommendation\model_files/surprise/book_embedding.npy')
sim_books_path = os.path.join(os.getcwd()+'/recommendation\model_files/surprise/sim_books.pickle')
...
def get_book_id(tittle):
    ...
    """
    return df_book[df_book['original_title'] == tittle]['book_id'].values[0]
...
def get_book_dict_by_tittle(bookTittle_list):
    ...
    """
    rec_books_dict = df_book[df_book['original_title'].isin(bookTittle_list)][cols].to_dict('records')
    return rec_books_dict
...
# for book in get_book_dict(tfidf_recommendations(1885)):
#     print('\n')
#     print(book)



# print(get_book_id('Pride and Prejudice'))
